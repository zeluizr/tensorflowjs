...
let arquivo = fs.readFileSync("src/cotacao-do-dolar.csv", {
  encoding: "utf-8",
});
...
const arrInput = [3.9572, 3.947, 3.9736, 3.9363]; // 09.05.2019
...
model
  ...
  .then(() => {
    ...
    console.log(`Maxima:     R$ ${Number(output[2]).toFixed(4)}`);
